...
int main()
{
    ...
    filename = "transcritical_no_shock_bump.dat"; // name of the file to save the results
    ...
    filename = "transcritical_shock_bump.dat"; // name of the file to save the results
